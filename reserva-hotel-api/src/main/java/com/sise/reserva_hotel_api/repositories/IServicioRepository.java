...
public interface IServicioRepository extends JpaRepository<ServicioAdicional, Integer>{
    ...
    List<ServicioAdicional> findByEstadoAuditoria(String estadoAuditoria, Sort sort);
    Page<ServicioAdicional> findByEstadoAuditoria(String estadoAuditoria, Pageable pageable);
